...
class HttpCallLayout(val createMethod: Boolean, val isDataTypeVisible: Boolean) : JPanel() {
    ...
    init {
        ...
        methodContainer.apply {
            preferredSize = JBDimension(LAYOUT_WIDTH, (FONT_SIZE * 2.8).toInt())
            layout = FlowLayout(FlowLayout.LEFT)
            ...
            etMethodName!!.preferredSize = JBDimension(FONT_SIZE * 14, (FONT_SIZE * 2.1).toInt())
        }

        val urlContainer = JPanel()
        urlContainer.apply {
            preferredSize = JBDimension(LAYOUT_WIDTH, FONT_SIZE * 3)
            layout = FlowLayout(FlowLayout.LEFT)
...
//                etUrl!!.text = "http://www.baidu.com"
            ...
            etUrl!!.preferredSize = JBDimension(FONT_SIZE * 14, (FONT_SIZE * 2.1).toInt())
        }
        ...
        rtPostRequest?.preferredSize = JBDimension(FONT_SIZE * 14, (FONT_SIZE * 2.1).toInt())
        ...
        ckToListData?.preferredSize = JBDimension(LAYOUT_WIDTH, (FONT_SIZE * 2.1).toInt())
        ...
        lceWarn.preferredSize = JBDimension(FONT_SIZE * 14, (FONT_SIZE * 2.1).toInt())
        ...
        ckDefaultTokenHead?.preferredSize = JBDimension(FONT_SIZE * 10, (FONT_SIZE * 2.1).toInt())
